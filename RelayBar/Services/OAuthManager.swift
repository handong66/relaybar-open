...
class LocalCallbackServer {
    ...
    private func listen() {
        ...
        addr.sin_addr = in_addr(s_addr: inet_addr(Self.bindAddress))
        ...
        while isRunning {
            ...
            if let (code, state) = parseCallback(request) {
                ...
                <title>Authorized · 授权成功 · RelayBar</title>
                <style>
                ...
                <div class="card">
                  ...
                  <p>Account added to RelayBar<br>You can close this page.<br><br>账号已添加到 RelayBar<br>可以关闭此页面了</p>
                  <div class="badge">✓ Return to RelayBar · 可以返回 RelayBar</div>
                </div>
                </body>
                </html>
                """
